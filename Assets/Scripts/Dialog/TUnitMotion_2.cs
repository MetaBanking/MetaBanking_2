...
{
    [Serializable]
    public abstract class TUnitMotion_2 : TUnit_2, IUnitMotion_2
    {
        private const float MIN_STOP_THRESHOLD = 0.01f;

        // MEMBERS: -------------------------------------------------------------------------------

        [NonSerialized] protected Character_2.MovementType m_MovementType;
        //[NonSerialized] protected TMotion_2 m_MotionData;
        ...
        public Character_2.MovementType MovementType
        {
        ...
        //public InteractionMode_2 InteractionMode
        //{
        ...
        public virtual void OnStartup(Character_2 character)
        {
            this.Character = character;
        }
        
        public virtual void AfterStartup(Character_2 character)
        {
            this.Character = character;
        }

        public virtual void OnDispose(Character_2 character)
        {
            this.Character = character;
        }
        ...
        public virtual void MoveToLocation(Location location, float stopDistance, 
            Action<Character_2> onFinish, int priority)
        {
        ...
        //protected bool UpdateMotionData<T>(int priority) where T : TMotion_2, new()
        //{
