...
namespace Character_2
{
    ...
    public class Character_2 : MonoBehaviour, ISpatialHash
    {
        ...
        private static Dictionary<IdString, Character_2> Characters;

        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)]
        private static void OnSubsystemsInit()
        {
            Characters = new Dictionary<IdString, Character_2>();
        }
        ...
        [SerializeField] protected Busy_2 m_Busy = new Busy_2();
        [SerializeField] protected CharacterKernel_2 m_Kernel = new CharacterKernel_2();
        ...
        [SerializeField] protected Interaction_2 m_Interaction = new Interaction_2();
        //[SerializeField] protected Footsteps m_Footsteps = new Footsteps();
        //[SerializeField] protected Ragdoll m_Ragdoll = new Ragdoll();
        [SerializeField] protected Props_2 m_Props = new Props_2();
        //[SerializeField] protected Combat m_Combat = new Combat();
        [SerializeField] protected Jump_2 m_Jump = new Jump_2();
        ...
        public Busy_2 Busy => this.m_Busy;
...

        {
            ...
            set
            {
                ShortcutPlayer_2.Change(value ? this : null);
        ...
        public Interaction_2 Interaction => this.m_Interaction;
        //public Footsteps Footsteps => m_Footsteps;
        //public Ragdoll Ragdoll => this.m_Ragdoll;
        public Props_2 Props => this.m_Props;
        //public Combat Combat => this.m_Combat;
        public Jump_2 Jump => this.m_Jump;
        ...
        public IUnitPlayer_2 Player => this.m_Kernel?.Player;
        public IUnitMotion_2 Motion => this.m_Kernel?.Motion;
        public IUnitDriver_2 Driver => this.m_Kernel?.Driver;
        //public IUnitFacing Facing => this.m_Kernel?.Facing;
        public IUnitAnimim_2 Animim => this.m_Kernel?.Animim;
        ...
        {
            if (this.IsPlayer) ShortcutPlayer_2.Change(this);
        ...
        public void OnLand(float velocity)
        {
            ...
            {
                _ = this.Busy.Timeout(Busy_2.Limb.Legs, 0.2f);
            }
        ...
        public static Character_2 GetCharacterByID(string characterID)
        {
            IdString id = new IdString(characterID);
            return GetCharacterByID(id);
        }

        public static Character_2 GetCharacterByID(IdString characterID)
        {
            return Characters.TryGetValue(characterID, out Character_2 character)
                ? character
                : null;
        }
        ...
        private void OnValidate()
        {
            ...
            this.m_Props ??= new Props_2();
            //this.m_Combat ??= new Combat();
            this.m_Jump ??= new Jump_2();

            this.m_Interaction ??= new Interaction_2();
        }
