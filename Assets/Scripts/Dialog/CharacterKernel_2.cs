...
{
    [Serializable]
    public class CharacterKernel_2 : ICharacterKernel_2
    {
        [SerializeReference] protected IUnitPlayer_2 m_Player;
        [SerializeReference] protected IUnitMotion_2 m_Motion;
        [SerializeReference] protected IUnitDriver_2 m_Driver;
        //[SerializeReference] protected IUnitFacing m_Facing;
        [SerializeReference] protected IUnitAnimim_2 m_Animim;
        ...
        public CharacterKernel_2()
        {
            IKernelPreset_2 preset = new KernelPreset3DController();
        ...
        public Character_2 Character { get; private set; }

        public IUnitPlayer_2 Player => this.m_Player;
        public IUnitMotion_2 Motion => this.m_Motion;
        public IUnitDriver_2 Driver => this.m_Driver;
        //public IUnitFacing Facing => this.m_Facing;
        public IUnitAnimim_2 Animim => this.m_Animim;

        // PUBLIC METHODS: ------------------------------------------------------------------------

        public void ChangePreset(Character_2 character, IKernelPreset_2 preset)
        {
        ...
        public void ChangePlayer(Character_2 character, IUnitPlayer_2 unit)
        {
            if (unit == null) return;
        ...
        public void ChangeMotion(Character_2 character, IUnitMotion_2 unit)
        {
            if (unit == null) return;
        ...
        public void ChangeDriver(Character_2 character, IUnitDriver_2 unit)
        {
            if (unit == null) return;
        ...
        public void ChangeAnimim(Character_2 character, IUnitAnimim_2 unit)
        {
            if (unit == null) return;
        ...
        public void OnStartup(Character_2 character)
        {
        ...
        public void AfterStartup(Character_2 character)
        {
            this.Character = character;
        ...
        public void OnDispose(Character_2 character)
        {
            this.Character = character;
        ...
        public virtual void OnDrawGizmos(Character_2 character)
        {
            #if UNITY_EDITOR
