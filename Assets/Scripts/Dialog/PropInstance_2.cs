...
{
    internal class PropInstance_2 : IProp_2
    {
        // MEMBERS: -------------------------------------------------------------------------------
        
        private readonly IBone_2 m_Bone;
        ...
        public PropInstance_2(IBone_2 bone, GameObject instance, Vector3 position, Quaternion rotation)
        {
            this.m_Bone = bone;
