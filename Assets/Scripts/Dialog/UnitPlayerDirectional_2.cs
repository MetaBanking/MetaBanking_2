...
namespace Character_2
{
    ...
    [Serializable]
    public class UnitPlayerDirectional_2 : TUnitPlayer_2
    {
        // EXPOSED MEMBERS: -----------------------------------------------------------------------
        ...
        public UnitPlayerDirectional_2()
        {
        ...
        public override void OnStartup(Character_2 character)
        {
            base.OnStartup(character);
            this.m_InputMove.OnStartup();
        }
        
        public override void OnDispose(Character_2 character)
        {
