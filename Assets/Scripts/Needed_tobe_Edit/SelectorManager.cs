...
//        public BoolReference DontDestroy = new BoolReference( true);
//        public BoolReference DontDestroySelectedItem = new BoolReference(true);

//        public BoolReference InstantiateItems = new BoolReference(true);                       //Instantiate the original items on the scene
//        public BoolReference RemoveLast = new BoolReference();
...
//        public BoolReference enableSelector = new BoolReference(true);
