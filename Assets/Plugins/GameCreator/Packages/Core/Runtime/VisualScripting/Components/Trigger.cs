...
namespace GameCreator.Runtime.VisualScripting
{
        ...
        ISignalReceiver
    {
        ...
        public async Task Execute(Args args)  // 2, 5
        {
        ...
        public async Task Execute(GameObject target) // 1, 4 
        {
            if (this.IsExecuting) return;
        ...
        private void OnStartInteraction(Character character, IInteractive interactive)  // 3
        {
