...
namespace GameCreator.Runtime.Dialogue
{
    ...
    public class Node
    {
        ...
        [SerializeField] private InstructionList m_OnStart = new InstructionList();
        [SerializeField] private InstructionList m_OnFinish = new InstructionList();
        ...
        [NonSerialized] private GameObject m_TemplateConditionsCanPlay;
        [NonSerialized] private GameObject m_TemplateInstructionsOnStart;
        [NonSerialized] private GameObject m_TemplateInstructionsOnFinish;
        ...
        {
            if (this.m_TemplateConditionsCanPlay == null)
            {
                this.m_TemplateConditionsCanPlay = RunConditionsList.CreateTemplate(
                    this.m_Conditions
                );
            }
            
            return RunConditionsList.Check(
                args, this.m_TemplateConditionsCanPlay,
                new RunnerConfig
                {
                    Name = "Can Run Node",
        ...
        {
            if (this.m_TemplateInstructionsOnStart == null)
            {
                this.m_TemplateInstructionsOnStart = RunInstructionsList.CreateTemplate(
                    this.m_OnStart
                );
            }
            
            await RunInstructionsList.Run(
                args.Clone, this.m_TemplateInstructionsOnStart, 
                new RunnerConfig
                {
                    Name = "On Start Node",
        ...
        {
            if (this.m_TemplateInstructionsOnFinish == null)
            {
                this.m_TemplateInstructionsOnFinish = RunInstructionsList.CreateTemplate(
                    this.m_OnFinish
                );
            }
            
            await RunInstructionsList.Run(
                args.Clone, this.m_TemplateInstructionsOnFinish, 
                new RunnerConfig
                {
                    Name = "On Finish Node",
                    Location = new RunnerLocationParent(args.ComponentFromSelf<Transform>())
